...
?>
<div class="container">
   <h2>FSIC - Occupancy Application</h2>
   <p>Fill up the application form for registration.</p>
      ...
      <form action="" method="post" class="jumbotron">
               ...
               <hr class="my-4">
               <div class="form-group row">
                  <label for="building_permit" class="col-md-2 control-label">Building Permit:</label>
                  <div class="col-md-10">
                     <input type="file" name="building_permit" id="building_permit" class="form-control" required>
                  </div>
               </div>
               <div class="form-group row">
                  <label for="building_plan" class="col-md-2 control-label">Approved Building Plan:</label>
                  <div class="col-md-10">
