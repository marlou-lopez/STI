...
?>
<div class="container">
   <h2>FSIC - Business Application</h2>
   <p>Fill up the application form for registration.</p>
      ...
      <form action="" method="post" class="jumbotron">
               ...
               <hr class="my-4">
               <div class="form-group row">
                  <label for="treasurer_or" class="col-md-2 control-label">Treasurer's Office Assessment Official Receipt: </label>
                  <div class="col-md-10">
                     <input type="file" name="treasurer_or" id="treasurer_or" class="form-control" required>
                  </div>
               </div>
               <div class="form-group row">
                  <label for="rpt_or" class="col-md-2 control-label">Official Receipt of Real Property Tax: </label>
                  <div class="col-md-10">
                     <input type="file" name="rpt_or" id="rpt_or" class="form-control" required>
                  </div>
               </div>
